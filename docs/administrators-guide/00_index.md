...
This docs describes all options specific to Administrators (requiriing elevated permissions).
For docs on how to manage a Paas (which could well be done by Administrators too) we need to refer you to [the user docs instead](../user-guide/)
